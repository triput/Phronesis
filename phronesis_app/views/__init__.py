...
from .trash import (
    trash_empty_view,
    trash_restore_container_view,
    trash_restore_item_view,
    trash_view,
)
from .matrix import (
...
from .settings import (
    ...
    settings_backup_clear_view,
    settings_backup_export_view,
    settings_backup_restore_view,
    ...
    settings_modules_save_view,
    settings_notifications_save_view,
    settings_sync_export_view,
    settings_sync_import_view,
