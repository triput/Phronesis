...
urlpatterns = [
    ...
    path("today/expand/", views.today_expand_view, name="today-expand"),
    path("today/visible-limit/", views.today_visible_limit_view, name="today-visible-limit"),
    ...
    path(
        "settings/targets/",
        views.settings_target_create_view,
        name="settings-target-create",
    ),
    path(
        "settings/targets/<int:target_id>/edit/",
        views.settings_target_edit_view,
        name="settings-target-edit",
    ),
    path(
        "settings/targets/<int:target_id>/update/",
        views.settings_target_update_view,
        name="settings-target-update",
    ),
    path(
        "settings/targets/<int:target_id>/delete/",
        views.settings_target_delete_view,
        name="settings-target-delete",
    ),
    # P4 surfaces
    ...
    path("canvas/habits/", views.habits_view, name="canvas-habits"),
    path("habits/create/", views.habit_create_view, name="habit-create"),
    path("habits/<int:habit_id>/check/", views.habit_check_view, name="habit-check"),
    path("habits/<int:habit_id>/skip/", views.habit_skip_view, name="habit-skip"),
    path(
        "habits/<int:habit_id>/clear/",
        views.habit_clear_check_view,
        name="habit-clear-check",
    ),
    path(
        "habits/<int:habit_id>/deactivate/",
        views.habit_deactivate_view,
        name="habit-deactivate",
    ),
